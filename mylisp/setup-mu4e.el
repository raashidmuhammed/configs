...
(add-to-list 'load-path "~/.emacs.d/elpa/mu4e-maildirs-extension-20160126.39/")
...
(setq
 user-mail-address "raashidmuhammed@zilogic.com"
 user-full-name  "Raashid Muhammed"
 message-signature
 (concat
  "--Regards,\n"
  "Raashid Muhammed"
...
(setq message-send-mail-function 'smtpmail-send-it
      ...
      '(("mail.zilogic.com" 25 "raashidmuhammed@zilogic.com" nil))
